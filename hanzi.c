#include "include.h"
const uint16_t GB2312_Unicode[][2] =
{
  {0xA1A1, 0x3000},  /* '　' -> 12288 */
  {0xA1A2, 0x3001},  /* '、' -> 12289 */
  {0xA1A3, 0x3002},  /* '。' -> 12290 */
...
{                                                                                              
	char ch;                                                                                     
	memset(&ch,0,1);                                                                             
	if(tmp >= 0xB0A1 && tmp <= 0XB0C4) ch='A';                                                   
	else if(tmp >=0xB0C5 && tmp <= 0xB2C0) ch='B';                                               
	else if(tmp >=0xB2C1 && tmp <= 0xB4ED) ch='C';                                               
	else if(tmp >=0xB4EE && tmp <= 0xB6E9) ch='D';                                               
	else if(tmp >=0xB6EA && tmp <= 0xB7A1) ch='E';                                               
	else if(tmp >=0xB7A2 && tmp <= 0xB8C0) ch='F';                                               
	else if(tmp >=0xB8C1 && tmp <= 0xB9FD) ch='G';                                               
	else if(tmp >=0xB9FE && tmp <= 0xBBF6) ch='H';                                               
	else if(tmp >=0xBBF7 && tmp <= 0xBFA5) ch='J';                                               
	else if(tmp >=0xBFA6 && tmp <= 0xC0AB) ch='K';                                               
	else if(tmp >=0xC0AC && tmp <= 0xC2E7) ch='L';                                               
	else if(tmp >=0xC2E8 && tmp <= 0xC4C2) ch='M';                                               
	else if(tmp >=0xC4C3 && tmp <= 0xC5B5) ch='N';                                               
	else if(tmp >=0xC5B6 && tmp <= 0xC5BD) ch='O';                                               
	else if(tmp >=0xC5BE && tmp <= 0xC6D9) ch='P';                                               
	else if(tmp >=0xC6DA && tmp <= 0xC8BA) ch='Q';                                               
	else if(tmp >=0xC8BB && tmp <= 0xC8F5) ch='R';                                               
	else if(tmp >=0xC8F6 && tmp <= 0xCBF9) ch='S';                                               
	else if(tmp >=0xCBFA && tmp <= 0xCDD9) ch='T';                                               
	else if(tmp >=0xCDDA && tmp <= 0xCEF3) ch='W';                                               
	else if(tmp >=0xCEF4 && tmp <= 0xD1B8) ch='X';                                               
...
{	                                                                                             
	...
	{                                                                                            
		...
		{                                                                                          
			a = ((*str) << 4) | ((*(str+1) & 0x3C) >>2) ;                                            
			b=(*(str+1)<<6) | (*(str+2) & 0x3f);                                                     
			d = a << 8 | b;                                                                          
			str+=3;                                                                                  
			for(k=0;k<4500;k++)                                                                      
			{                                                                                        
				if(d==GB2312_Unicode[k][1])                                                            
				{                                                                                      
					if(judge(GB2312_Unicode[k][0]))                                                      
					{                                                                                    
						my_str[num]=judge(GB2312_Unicode[k][0]);                                           
						num+=1;                                                                            
					}                                                                                    
				}                                                                                      
			}                                                                                        
...
{
	if(strstr(voice_str,"百分之二十一") || strstr(voice_str,"21%"))
		return 21;
	else if(strstr(voice_str,"百分之二十二") || strstr(voice_str,"22%"))
		return 22;
	else if(strstr(voice_str,"百分之二十三") || strstr(voice_str,"23%"))
		return 23;
	else if(strstr(voice_str,"百分之二十四") || strstr(voice_str,"24%"))
		return 24;
	else if(strstr(voice_str,"百分之二十五") || strstr(voice_str,"25%"))
		return 25;
	else if(strstr(voice_str,"百分之二十六") || strstr(voice_str,"26%"))
		return 26;
	else if(strstr(voice_str,"百分之二十七") || strstr(voice_str,"27%"))
		return 27;
	else if(strstr(voice_str,"百分之二十八") || strstr(voice_str,"28%"))
		return 28;
	else if(strstr(voice_str,"百分之二十九") || strstr(voice_str,"29%"))
		return 29;
	else if(strstr(voice_str,"百分之三十一") || strstr(voice_str,"31%"))
		return 31;
	else if(strstr(voice_str,"百分之三十二") || strstr(voice_str,"32%"))
		return 32;
	else if(strstr(voice_str,"百分之三十三") || strstr(voice_str,"33%"))
		return 33;
	else if(strstr(voice_str,"百分之三十四") || strstr(voice_str,"34%"))
		return 34;
	else if(strstr(voice_str,"百分之三十五") || strstr(voice_str,"35%"))
		return 35;
	else if(strstr(voice_str,"百分之三十六") || strstr(voice_str,"36%"))
		return 36;
	else if(strstr(voice_str,"百分之三十七") || strstr(voice_str,"37%"))
		return 37;
	else if(strstr(voice_str,"百分之三十八") || strstr(voice_str,"38%"))
		return 38;
	else if(strstr(voice_str,"百分之三十九") || strstr(voice_str,"39%"))
		return 39;
	else if(strstr(voice_str,"百分之四十一") || strstr(voice_str,"41%"))
		return 41;
	else if(strstr(voice_str,"百分之四十二") || strstr(voice_str,"42%"))
		return 42;
	else if(strstr(voice_str,"百分之四十三") || strstr(voice_str,"43%"))
		return 43;
	else if(strstr(voice_str,"百分之四十四") || strstr(voice_str,"44%"))
		return 44;
	else if(strstr(voice_str,"百分之四十五") || strstr(voice_str,"45%"))
		return 45;
	else if(strstr(voice_str,"百分之四十六") || strstr(voice_str,"46%"))
		return 46;
	else if(strstr(voice_str,"百分之四十七") || strstr(voice_str,"47%"))
		return 47;
	else if(strstr(voice_str,"百分之四十八") || strstr(voice_str,"48%"))
		return 48;
	else if(strstr(voice_str,"百分之四十九") || strstr(voice_str,"49%"))
		return 49;
	else if(strstr(voice_str,"百分之五十一") || strstr(voice_str,"51%"))
		return 51;
	else if(strstr(voice_str,"百分之五十二") || strstr(voice_str,"52%"))
		return 52;
	else if(strstr(voice_str,"百分之五十三") || strstr(voice_str,"53%"))
		return 53;
	else if(strstr(voice_str,"百分之五十四") || strstr(voice_str,"54%"))
		return 54;
	else if(strstr(voice_str,"百分之五十五") || strstr(voice_str,"55%"))
		return 55;
	else if(strstr(voice_str,"百分之五十六") || strstr(voice_str,"56%"))
		return 56;
	else if(strstr(voice_str,"百分之五十七") || strstr(voice_str,"57%"))
		return 57;
	else if(strstr(voice_str,"百分之五十八") || strstr(voice_str,"58%"))
		return 58;
	else if(strstr(voice_str,"百分之五十九") || strstr(voice_str,"59%"))
		return 59;
	else if(strstr(voice_str,"百分之六十一") || strstr(voice_str,"61%"))
		return 61;
	else if(strstr(voice_str,"百分之六十二") || strstr(voice_str,"62%"))
		return 62;
	else if(strstr(voice_str,"百分之六十三") || strstr(voice_str,"63%"))
		return 63;
	else if(strstr(voice_str,"百分之六十四") || strstr(voice_str,"64%"))
		return 64;
	else if(strstr(voice_str,"百分之六十五") || strstr(voice_str,"65%"))
		return 65;
	else if(strstr(voice_str,"百分之六十六") || strstr(voice_str,"66%"))
		return 66;
	else if(strstr(voice_str,"百分之六十七") || strstr(voice_str,"67%"))
		return 67;
	else if(strstr(voice_str,"百分之六十八") || strstr(voice_str,"68%"))
		return 68;
	else if(strstr(voice_str,"百分之六十九") || strstr(voice_str,"69%"))
		return 69;
	else if(strstr(voice_str,"百分之七十一") || strstr(voice_str,"71%"))
		return 71;
	else if(strstr(voice_str,"百分之七十二") || strstr(voice_str,"72%"))
		return 72;
	else if(strstr(voice_str,"百分之七十三") || strstr(voice_str,"73%"))
		return 73;
	else if(strstr(voice_str,"百分之七十四") || strstr(voice_str,"74%"))
		return 74;
	else if(strstr(voice_str,"百分之七十五") || strstr(voice_str,"75%"))
		return 75;
	else if(strstr(voice_str,"百分之七十六") || strstr(voice_str,"76%"))
		return 76;
	else if(strstr(voice_str,"百分之七十七") || strstr(voice_str,"77%"))
		return 77;
	else if(strstr(voice_str,"百分之七十八") || strstr(voice_str,"78%"))
		return 78;
	else if(strstr(voice_str,"百分之七十九") || strstr(voice_str,"79%"))
		return 79;
	else if(strstr(voice_str,"百分之八十一") || strstr(voice_str,"81%"))
		return 81;
	else if(strstr(voice_str,"百分之八十二") || strstr(voice_str,"82%"))
		return 82;
	else if(strstr(voice_str,"百分之八十三") || strstr(voice_str,"83%"))
		return 83;
	else if(strstr(voice_str,"百分之八十四") || strstr(voice_str,"84%"))
		return 84;
	else if(strstr(voice_str,"百分之八十五") || strstr(voice_str,"85%"))
		return 85;
	else if(strstr(voice_str,"百分之八十六") || strstr(voice_str,"86%"))
		return 86;
	else if(strstr(voice_str,"百分之八十七") || strstr(voice_str,"87%"))
		return 87;
	else if(strstr(voice_str,"百分之八十八") || strstr(voice_str,"88%"))
		return 88;
	else if(strstr(voice_str,"百分之八十九") || strstr(voice_str,"89%"))
		return 89;
	else if(strstr(voice_str,"百分之九十一") || strstr(voice_str,"91%"))
		return 91;
	else if(strstr(voice_str,"百分之九十二") || strstr(voice_str,"92%"))
		return 92;
	else if(strstr(voice_str,"百分之九十三") || strstr(voice_str,"93%"))
		return 93;
	else if(strstr(voice_str,"百分之九十四") || strstr(voice_str,"94%"))
		return 94;
	else if(strstr(voice_str,"百分之九十五") || strstr(voice_str,"95%"))
		return 95;
	else if(strstr(voice_str,"百分之九十六") || strstr(voice_str,"96%"))
		return 96;
	else if(strstr(voice_str,"百分之九十七") || strstr(voice_str,"97%"))
		return 97;
	else if(strstr(voice_str,"百分之九十八") || strstr(voice_str,"98%"))
		return 98;
	else if(strstr(voice_str,"百分之九十九") || strstr(voice_str,"99%"))
		return 99;
	else if(strstr(voice_str,"百分之十一") || strstr(voice_str,"11%"))
		return 11;
	else if(strstr(voice_str,"百分之十二") || strstr(voice_str,"12%"))
		return 12;
	else if(strstr(voice_str,"百分之十三") || strstr(voice_str,"13%"))
		return 13;
	else if(strstr(voice_str,"百分之十四") || strstr(voice_str,"14%"))
		return 14;
	else if(strstr(voice_str,"百分之十五") || strstr(voice_str,"15%"))
		return 15;
	else if(strstr(voice_str,"百分之十六") || strstr(voice_str,"16%"))
		return 16;
	else if(strstr(voice_str,"百分之十七") || strstr(voice_str,"17%"))
		return 17;
	else if(strstr(voice_str,"百分之十八") || strstr(voice_str,"18%"))
		return 18;
	else if(strstr(voice_str,"百分之十九") || strstr(voice_str,"19%"))
		return 19;
	else if(strstr(voice_str,"百分之二十") || strstr(voice_str,"20%"))
		return 20;
	else if(strstr(voice_str,"百分之三十") || strstr(voice_str,"30%"))
		return 30;
	else if(strstr(voice_str,"百分之四十") || strstr(voice_str,"40%"))
		return 40;
	else if(strstr(voice_str,"百分之五十") || strstr(voice_str,"50%"))
		return 50;
	else if(strstr(voice_str,"百分之六十") || strstr(voice_str,"60%"))
		return 60;
	else if(strstr(voice_str,"百分之七十") || strstr(voice_str,"70%"))
		return 70;
	else if(strstr(voice_str,"百分之八十") || strstr(voice_str,"80%"))
		return 80;
	else if(strstr(voice_str,"百分之九十") || strstr(voice_str,"90%"))
		return 90;
	else if(strstr(voice_str,"百分之一百") || strstr(voice_str,"100%"))
		return 100;
	else if(strstr(voice_str,"百分之一") || strstr(voice_str,"1%"))
		return 1;
	else if(strstr(voice_str,"百分之二") || strstr(voice_str,"2%"))
		return 2;
	else if(strstr(voice_str,"百分之三") || strstr(voice_str,"3%"))
		return 3;
	else if(strstr(voice_str,"百分之四") || strstr(voice_str,"4%"))
		return 4;
	else if(strstr(voice_str,"百分之五") || strstr(voice_str,"5%"))
		return 5;
	else if(strstr(voice_str,"百分之六") || strstr(voice_str,"6%"))
		return 6;
	else if(strstr(voice_str,"百分之七") || strstr(voice_str,"7%"))
		return 7;
	else if(strstr(voice_str,"百分之八") || strstr(voice_str,"8%"))
		return 8;
	else if(strstr(voice_str,"百分之九") || strstr(voice_str,"9%"))
		return 9;
	else if(strstr(voice_str,"百分之十") || strstr(voice_str,"10%"))
		return 10;
	else if(strstr(voice_str,"百分之百") || strstr(voice_str,"100%"))
		return 100;
	else if(strstr(voice_str,"百分之零") || strstr(voice_str,"0%"))
		return 0;
	else if(strstr(voice_str,"一半") || strstr(voice_str,"50%"))
		return 50;
	else
		return 255;
}
...
{
	if(strstr(voice_str,"二十一") || strstr(voice_str,"21"))
		return 21;
	else if(strstr(voice_str,"二十二") || strstr(voice_str,"22"))
		return 22;
	else if(strstr(voice_str,"二十三") || strstr(voice_str,"23"))
		return 23;
	else if(strstr(voice_str,"二十四") || strstr(voice_str,"24"))
		return 24;
	else if(strstr(voice_str,"二十五") || strstr(voice_str,"25"))
		return 25;
	else if(strstr(voice_str,"二十六") || strstr(voice_str,"26"))
		return 26;
	else if(strstr(voice_str,"二十七") || strstr(voice_str,"27"))
		return 27;
	else if(strstr(voice_str,"二十八") || strstr(voice_str,"28"))
		return 28;
	else if(strstr(voice_str,"二十九") || strstr(voice_str,"29"))
		return 29;
	else if(strstr(voice_str,"三十一") || strstr(voice_str,"31"))
		return 31;
	else if(strstr(voice_str,"三十二") || strstr(voice_str,"32"))
		return 32;
	else if(strstr(voice_str,"三十三") || strstr(voice_str,"33"))
		return 33;
	else if(strstr(voice_str,"三十四") || strstr(voice_str,"34"))
		return 34;
	else if(strstr(voice_str,"三十五") || strstr(voice_str,"35"))
		return 35;
	else if(strstr(voice_str,"十一") || strstr(voice_str,"11"))
		return 11;
	else if(strstr(voice_str,"十二") || strstr(voice_str,"12"))
		return 12;
	else if(strstr(voice_str,"十三") || strstr(voice_str,"13"))
		return 13;
	else if(strstr(voice_str,"十四") || strstr(voice_str,"14"))
		return 14;
	else if(strstr(voice_str,"十五") || strstr(voice_str,"15"))
		return 15;
	else if(strstr(voice_str,"十六") || strstr(voice_str,"16"))
		return 16;
	else if(strstr(voice_str,"十七") || strstr(voice_str,"17"))
		return 17;
	else if(strstr(voice_str,"十八") || strstr(voice_str,"18"))
		return 18;
	else if(strstr(voice_str,"十九") || strstr(voice_str,"19"))
		return 19;
	else if(strstr(voice_str,"二十") || strstr(voice_str,"20"))
		return 20;
	else if(strstr(voice_str,"三十") || strstr(voice_str,"30"))
		return 30;
	else if(strstr(voice_str,"十") || strstr(voice_str,"10"))
		return 10;
	else if(strstr(voice_str,"一") || strstr(voice_str,"1"))
		return 1;
	else if(strstr(voice_str,"二") || strstr(voice_str,"2"))
		return 2;
	else if(strstr(voice_str,"三") || strstr(voice_str,"3"))
		return 3;
	else if(strstr(voice_str,"四") || strstr(voice_str,"4"))
		return 4;
	else if(strstr(voice_str,"五") || strstr(voice_str,"5"))
		return 5;
	else if(strstr(voice_str,"六") || strstr(voice_str,"6"))
		return 6;
	else if(strstr(voice_str,"七") || strstr(voice_str,"7"))
		return 7;
	else if(strstr(voice_str,"八") || strstr(voice_str,"8"))
		return 8;
	else if(strstr(voice_str,"九") || strstr(voice_str,"9"))
		return 9;
	else if(strstr(voice_str,"零") || strstr(voice_str,"0"))
		return 0;
	else
		return 255;
}
...
{
	if(strstr(voice_str,"二十一小时") || strstr(voice_str,"二十一个小时") || strstr(voice_str,"21小时") || strstr(voice_str,"21个小时"))
		return 21;
	else if(strstr(voice_str,"二十二小时") || strstr(voice_str,"二十二个小时") || strstr(voice_str,"22小时") || strstr(voice_str,"22个小时"))
		return 22;
	else if(strstr(voice_str,"二十三小时") || strstr(voice_str,"二十三个小时") || strstr(voice_str,"23小时") || strstr(voice_str,"23个小时"))
		return 23;
	else if(strstr(voice_str,"十一小时") || strstr(voice_str,"十一个小时") || strstr(voice_str,"11小时") || strstr(voice_str,"11个小时"))
		return 11;
	else if(strstr(voice_str,"十二小时") || strstr(voice_str,"十二个小时") || strstr(voice_str,"12小时") || strstr(voice_str,"12个小时"))
		return 12;
	else if(strstr(voice_str,"十三小时") || strstr(voice_str,"十三个小时") || strstr(voice_str,"13小时") || strstr(voice_str,"13个小时"))
		return 13;
	else if(strstr(voice_str,"十四小时") || strstr(voice_str,"十四个小时") || strstr(voice_str,"14小时") || strstr(voice_str,"14个小时"))
		return 14;
	else if(strstr(voice_str,"十五小时") || strstr(voice_str,"十五个小时") || strstr(voice_str,"15小时") || strstr(voice_str,"15个小时"))
		return 15;
	else if(strstr(voice_str,"十六小时") || strstr(voice_str,"十六个小时") || strstr(voice_str,"16小时") || strstr(voice_str,"16个小时"))
		return 16;
	else if(strstr(voice_str,"十七小时") ||  strstr(voice_str,"十七个小时") || strstr(voice_str,"17小时") || strstr(voice_str,"17个小时"))
		return 17;
	else if(strstr(voice_str,"十八小时") || strstr(voice_str,"十八个小时") || strstr(voice_str,"18小时") || strstr(voice_str,"18个小时"))
		return 18;
	else if(strstr(voice_str,"十九小时") || strstr(voice_str,"十九个小时") || strstr(voice_str,"19小时") || strstr(voice_str,"19个小时"))
		return 19;
	else if(strstr(voice_str,"十小时") || strstr(voice_str,"十个小时") || strstr(voice_str,"10小时") || strstr(voice_str,"10个小时"))
		return 10;
	else if(strstr(voice_str,"一小时") || strstr(voice_str,"一个小时") || strstr(voice_str,"1小时") || strstr(voice_str,"1个小时"))
		return 1;
	else if(strstr(voice_str,"二小时") || strstr(voice_str,"2小时") || strstr(voice_str,"两小时") || strstr(voice_str,"两个小时"))
		return 2;
	else if(strstr(voice_str,"三小时") || strstr(voice_str,"三个小时") || strstr(voice_str,"3小时") || strstr(voice_str,"3个小时"))
		return 3;
	else if(strstr(voice_str,"四小时") || strstr(voice_str,"四个小时") || strstr(voice_str,"4小时") || strstr(voice_str,"4个小时"))
		return 4;
	else if(strstr(voice_str,"五小时") || strstr(voice_str,"五个小时") || strstr(voice_str,"5小时") || strstr(voice_str,"5个小时"))
		return 5;
	else if(strstr(voice_str,"六小时") || strstr(voice_str,"六个小时") || strstr(voice_str,"6小时") || strstr(voice_str,"6个小时"))
		return 6;
	else if(strstr(voice_str,"七小时") || strstr(voice_str,"七个小时") || strstr(voice_str,"7小时") || strstr(voice_str,"7个小时"))
		return 7;
	else if(strstr(voice_str,"八小时") || strstr(voice_str,"八个小时") || strstr(voice_str,"8小时") || strstr(voice_str,"8个小时"))
		return 8;
	else if(strstr(voice_str,"九小时") || strstr(voice_str,"九个小时") || strstr(voice_str,"9小时") || strstr(voice_str,"9个小时"))
		return 9;
	else
		return 255;
}
...
{
	if(strstr(voice_str,"二十一分钟") || strstr(voice_str,"21分钟"))
		return 21;
	else if(strstr(voice_str,"二十二分钟") || strstr(voice_str,"22分钟"))
		return 22;
	else if(strstr(voice_str,"二十三分钟") || strstr(voice_str,"23分钟"))
		return 23;
	else if(strstr(voice_str,"二十四分钟") || strstr(voice_str,"24分钟"))
		return 24;
	else if(strstr(voice_str,"二十五分钟") || strstr(voice_str,"25分钟"))
		return 25;
	else if(strstr(voice_str,"二十六分钟") || strstr(voice_str,"26分钟"))
		return 26;
	else if(strstr(voice_str,"二十七分钟") || strstr(voice_str,"27分钟"))
		return 27;
	else if(strstr(voice_str,"二十八分钟") || strstr(voice_str,"28分钟"))
		return 28;
	else if(strstr(voice_str,"二十九分钟") || strstr(voice_str,"29分钟"))
		return 29;
	else if(strstr(voice_str,"三十一分钟") || strstr(voice_str,"31分钟"))
		return 31;
	else if(strstr(voice_str,"三十二分钟") || strstr(voice_str,"32分钟"))
		return 32;
	else if(strstr(voice_str,"三十三分钟") || strstr(voice_str,"33分钟"))
		return 33;
	else if(strstr(voice_str,"三十四分钟") || strstr(voice_str,"34分钟"))
		return 34;
	else if(strstr(voice_str,"三十五分钟") || strstr(voice_str,"35分钟"))
		return 35;
	else if(strstr(voice_str,"三十六分钟") || strstr(voice_str,"36分钟"))
		return 36;
	else if(strstr(voice_str,"三十七分钟") || strstr(voice_str,"37分钟"))
		return 37;
	else if(strstr(voice_str,"三十八分钟") || strstr(voice_str,"38分钟"))
		return 38;
	else if(strstr(voice_str,"三十九分钟") || strstr(voice_str,"39分钟"))
		return 39;
	else if(strstr(voice_str,"四十一分钟") || strstr(voice_str,"41分钟"))
		return 41;
	else if(strstr(voice_str,"四十二分钟") || strstr(voice_str,"42分钟"))
		return 42;
	else if(strstr(voice_str,"四十三分钟") || strstr(voice_str,"43分钟"))
		return 43;
	else if(strstr(voice_str,"四十四分钟") || strstr(voice_str,"44分钟"))
		return 44;
	else if(strstr(voice_str,"四十五分钟") || strstr(voice_str,"45分钟"))
		return 45;
	else if(strstr(voice_str,"四十六分钟") || strstr(voice_str,"46分钟"))
		return 46;
	else if(strstr(voice_str,"四十七分钟") || strstr(voice_str,"47分钟"))
		return 47;
	else if(strstr(voice_str,"四十八分钟") || strstr(voice_str,"48分钟"))
		return 48;
	else if(strstr(voice_str,"四十九分钟") || strstr(voice_str,"49分钟"))
		return 49;
	else if(strstr(voice_str,"五十一分钟") || strstr(voice_str,"51分钟"))
		return 51;
	else if(strstr(voice_str,"五十二分钟") || strstr(voice_str,"52分钟"))
		return 52;
	else if(strstr(voice_str,"五十三分钟") || strstr(voice_str,"53分钟"))
		return 53;
	else if(strstr(voice_str,"五十四分钟") || strstr(voice_str,"54分钟"))
		return 54;
	else if(strstr(voice_str,"五十五分钟") || strstr(voice_str,"55分钟"))
		return 55;
	else if(strstr(voice_str,"五十六分钟") || strstr(voice_str,"56分钟"))
		return 56;
	else if(strstr(voice_str,"五十七分钟") || strstr(voice_str,"57分钟"))
		return 57;
	else if(strstr(voice_str,"五十八分钟") || strstr(voice_str,"58分钟"))
		return 58;
	else if(strstr(voice_str,"五十九分钟") || strstr(voice_str,"59分钟"))
		return 59;
	else if(strstr(voice_str,"十一分钟") || strstr(voice_str,"11分钟"))
		return 11;
	else if(strstr(voice_str,"十二分钟") || strstr(voice_str,"12分钟"))
		return 12;
	else if(strstr(voice_str,"十三分钟") || strstr(voice_str,"13分钟"))
		return 13;
	else if(strstr(voice_str,"十四分钟") || strstr(voice_str,"14分钟"))
		return 14;
	else if(strstr(voice_str,"十五分钟") || strstr(voice_str,"15分钟"))
		return 15;
	else if(strstr(voice_str,"十六分钟") || strstr(voice_str,"16分钟"))
		return 16;
	else if(strstr(voice_str,"十七分钟") || strstr(voice_str,"17分钟"))
		return 17;
	else if(strstr(voice_str,"十八分钟") || strstr(voice_str,"18分钟"))
		return 18;
	else if(strstr(voice_str,"十九分钟") || strstr(voice_str,"19分钟"))
		return 19;
	else if(strstr(voice_str,"二十分钟") || strstr(voice_str,"20分钟"))
		return 20;
	else if(strstr(voice_str,"三十分钟") || strstr(voice_str,"30分钟"))
		return 30;
	else if(strstr(voice_str,"四十分钟") || strstr(voice_str,"40分钟"))
		return 40;
	else if(strstr(voice_str,"五十分钟") || strstr(voice_str,"50分钟"))
		return 50;
	else if(strstr(voice_str,"六十分钟") || strstr(voice_str,"60分钟"))
		return 60;
	else if(strstr(voice_str,"十分钟") || strstr(voice_str,"10分钟"))
		return 10;
	else if(strstr(voice_str,"一分钟") || strstr(voice_str,"1分钟"))
		return 1;
	else if(strstr(voice_str,"二分钟") || strstr(voice_str,"2分钟") || strstr(voice_str,"两分钟"))
		return 2;
	else if(strstr(voice_str,"三分钟") || strstr(voice_str,"3分钟"))
		return 3;
	else if(strstr(voice_str,"四分钟") || strstr(voice_str,"4分钟"))
		return 4;
	else if(strstr(voice_str,"五分钟") || strstr(voice_str,"5分钟"))
		return 5;
	else if(strstr(voice_str,"六分钟") || strstr(voice_str,"6分钟"))
		return 6;
	else if(strstr(voice_str,"七分钟") || strstr(voice_str,"7分钟"))
		return 7;
	else if(strstr(voice_str,"八分钟") || strstr(voice_str,"8分钟"))
		return 8;
	else if(strstr(voice_str,"九分钟") || strstr(voice_str,"9分钟"))
		return 9;
	else
		return 255;
}
...
{
	if(strstr(voice_str,"二十一秒") || strstr(voice_str,"21秒"))
		return 21;
	else if(strstr(voice_str,"二十二秒") || strstr(voice_str,"22秒"))
		return 22;
	else if(strstr(voice_str,"二十三秒") || strstr(voice_str,"23秒"))
		return 23;
	else if(strstr(voice_str,"二十四秒") || strstr(voice_str,"24秒"))
		return 24;
	else if(strstr(voice_str,"二十五秒") || strstr(voice_str,"25秒"))
		return 25;
	else if(strstr(voice_str,"二十六秒") || strstr(voice_str,"26秒"))
		return 26;
	else if(strstr(voice_str,"二十七秒") || strstr(voice_str,"27秒"))
		return 27;
	else if(strstr(voice_str,"二十八秒") || strstr(voice_str,"28秒"))
		return 28;
	else if(strstr(voice_str,"二十九秒") || strstr(voice_str,"29秒"))
		return 29;
	else if(strstr(voice_str,"三十一秒") || strstr(voice_str,"31秒"))
		return 31;
	else if(strstr(voice_str,"三十二秒") || strstr(voice_str,"32秒"))
		return 32;
	else if(strstr(voice_str,"三十三秒") || strstr(voice_str,"33秒"))
		return 33;
	else if(strstr(voice_str,"三十四秒") || strstr(voice_str,"34秒"))
		return 34;
	else if(strstr(voice_str,"三十五秒") || strstr(voice_str,"35秒"))
		return 35;
	else if(strstr(voice_str,"三十六秒") || strstr(voice_str,"36秒"))
		return 36;
	else if(strstr(voice_str,"三十七秒") || strstr(voice_str,"37秒"))
		return 37;
	else if(strstr(voice_str,"三十八秒") || strstr(voice_str,"38秒"))
		return 38;
	else if(strstr(voice_str,"三十九秒") || strstr(voice_str,"39秒"))
		return 39;
	else if(strstr(voice_str,"四十一秒") || strstr(voice_str,"41秒"))
		return 41;
	else if(strstr(voice_str,"四十二秒") || strstr(voice_str,"42秒"))
		return 42;
	else if(strstr(voice_str,"四十三秒") || strstr(voice_str,"43秒"))
		return 43;
	else if(strstr(voice_str,"四十四秒") || strstr(voice_str,"44秒"))
		return 44;
	else if(strstr(voice_str,"四十五秒") || strstr(voice_str,"45秒"))
		return 45;
	else if(strstr(voice_str,"四十六秒") || strstr(voice_str,"46秒"))
		return 46;
	else if(strstr(voice_str,"四十七秒") || strstr(voice_str,"47秒"))
		return 47;
	else if(strstr(voice_str,"四十八秒") || strstr(voice_str,"48秒"))
		return 48;
	else if(strstr(voice_str,"四十九秒") || strstr(voice_str,"49秒"))
		return 49;
	else if(strstr(voice_str,"五十一秒") || strstr(voice_str,"51秒"))
		return 51;
	else if(strstr(voice_str,"五十二秒") || strstr(voice_str,"52秒"))
		return 52;
	else if(strstr(voice_str,"五十三秒") || strstr(voice_str,"53秒"))
		return 53;
	else if(strstr(voice_str,"五十四秒") || strstr(voice_str,"54秒"))
		return 54;
	else if(strstr(voice_str,"五十五秒") || strstr(voice_str,"55秒"))
		return 55;
	else if(strstr(voice_str,"五十六秒") || strstr(voice_str,"56秒"))
		return 56;
	else if(strstr(voice_str,"五十七秒") || strstr(voice_str,"57秒"))
		return 57;
	else if(strstr(voice_str,"五十八秒") || strstr(voice_str,"58秒"))
		return 58;
	else if(strstr(voice_str,"五十九秒") || strstr(voice_str,"59秒"))
		return 59;
	else if(strstr(voice_str,"十一秒") || strstr(voice_str,"11秒"))
		return 11;
	else if(strstr(voice_str,"十二秒") || strstr(voice_str,"12秒"))
		return 12;
	else if(strstr(voice_str,"十三秒") || strstr(voice_str,"13秒"))
		return 13;
	else if(strstr(voice_str,"十四秒") || strstr(voice_str,"14秒"))
		return 14;
	else if(strstr(voice_str,"十五秒") || strstr(voice_str,"15秒"))
		return 15;
	else if(strstr(voice_str,"十六秒") || strstr(voice_str,"16秒"))
		return 16;
	else if(strstr(voice_str,"十七秒") || strstr(voice_str,"17秒"))
		return 17;
	else if(strstr(voice_str,"十八秒") || strstr(voice_str,"18秒"))
		return 18;
	else if(strstr(voice_str,"十九秒") || strstr(voice_str,"19秒"))
		return 19;
	else if(strstr(voice_str,"二十秒") || strstr(voice_str,"20秒"))
		return 20;
	else if(strstr(voice_str,"三十秒") || strstr(voice_str,"30秒"))
		return 30;
	else if(strstr(voice_str,"四十秒") || strstr(voice_str,"40秒"))
		return 40;
	else if(strstr(voice_str,"五十秒") || strstr(voice_str,"50秒"))
		return 50;
	else if(strstr(voice_str,"六十秒") || strstr(voice_str,"60秒"))
		return 60;
	else if(strstr(voice_str,"十秒") || strstr(voice_str,"10秒"))
		return 10;
	else if(strstr(voice_str,"一秒") || strstr(voice_str,"1秒"))
		return 1;
	else if(strstr(voice_str,"二秒") || strstr(voice_str,"2秒") || strstr(voice_str,"两秒"))
		return 2;
	else if(strstr(voice_str,"三秒") || strstr(voice_str,"3秒"))
		return 3;
	else if(strstr(voice_str,"四秒") || strstr(voice_str,"4秒"))
		return 4;
	else if(strstr(voice_str,"五秒") || strstr(voice_str,"5秒"))
		return 5;
	else if(strstr(voice_str,"六秒") || strstr(voice_str,"6秒"))
		return 6;
	else if(strstr(voice_str,"七秒") || strstr(voice_str,"7秒"))
		return 7;
	else if(strstr(voice_str,"八秒") || strstr(voice_str,"8秒"))
		return 8;
	else if(strstr(voice_str,"九秒") || strstr(voice_str,"9秒"))
		return 9;
	else
		return 255;
}
